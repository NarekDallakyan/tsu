...
import social.tsu.frame.FrameManager;
import social.tsu.gesture.Gesture;
import social.tsu.internal.utils.Op;
import social.tsu.internal.utils.WorkerHandler;
import social.tsu.overlay.Overlay;
import social.tsu.picture.PictureRecorder;
...
import social.tsu.video.VideoRecorder;
...
public abstract class CameraEngine implements
    ...
    @VisibleForTesting
    Step mEngineStep = new Step("engine", new Step.StepCallback() {
        @Override
        @NonNull
    ...
    private Step mBindStep = new Step("bind", new Step.StepCallback() {
        @Override
        @NonNull
        public Executor getExecutor() {
            return mHandler.getExecutor();
    ...
    private Step mPreviewStep = new Step("preview", new Step.StepCallback() {
        @Override
        @NonNull
        public Executor getExecutor() {
            return mHandler.getExecutor();
    ...
    private Step mAllStep = new Step("all", new Step.StepCallback() {
        @Override
        @NonNull
        public Executor getExecutor() {
            return mHandler.getExecutor();
     ...
     * <p>
     * If so, implementors should set  and any other information
