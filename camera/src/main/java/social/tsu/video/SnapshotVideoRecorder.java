...
import social.tsu.internal.DeviceEncoders;
import social.tsu.overlay.Overlay;
import social.tsu.overlay.OverlayDrawer;
import social.tsu.preview.GlCameraPreview;
import social.tsu.preview.RendererFrameCallback;
import social.tsu.preview.RendererThread;
...
import social.tsu.video.encoding.TextureConfig;
import social.tsu.video.encoding.TextureMediaEncoder;
    ...
    public void onRendererFrame(@NonNull SurfaceTexture surfaceTexture, float scaleX, float scaleY) {
        if (mCurrentState == STATE_NOT_RECORDING && mDesiredState == STATE_RECORDING) {
            ...
            if (mResult.videoBitRate <= 0)
                mResult.videoBitRate = estimateVideoBitRate(mResult.size, mResult.videoFrameRate);
