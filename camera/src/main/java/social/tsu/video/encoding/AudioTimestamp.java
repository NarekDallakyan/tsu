...
public class AudioTimestamp {
    ...
    private long mGapUs;
    public AudioTimestamp(int byteRate) {
        mByteRate = byteRate;
    }

    public static long bytesToUs(long bytes, int byteRate) {
        return (1000000L * bytes) / byteRate;
    }

    public static long bytesToMillis(long bytes, int byteRate) {
    ...
    public long increaseUs(int readBytes) {
     ...
     */
    public int getGapCount(int frameBytes) {
     ...
     */
    public long getGapStartUs(long lastTimeUs) {
