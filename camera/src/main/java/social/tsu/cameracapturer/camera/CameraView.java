...
import social.tsu.cameracapturer.control.Audio;
import social.tsu.cameracapturer.control.Control;
import social.tsu.cameracapturer.control.ControlParser;
import social.tsu.cameracapturer.control.Engine;
import social.tsu.cameracapturer.control.Facing;
import social.tsu.cameracapturer.control.Flash;
import social.tsu.cameracapturer.control.Grid;
import social.tsu.cameracapturer.control.Hdr;
import social.tsu.cameracapturer.control.Mode;
import social.tsu.cameracapturer.control.Preview;
import social.tsu.cameracapturer.control.VideoCodec;
import social.tsu.cameracapturer.control.WhiteBalance;
import social.tsu.cameracapturer.engine.Camera1Engine;
import social.tsu.cameracapturer.engine.Camera2Engine;
import social.tsu.cameracapturer.engine.CameraEngine;
import social.tsu.cameracapturer.engine.offset.Reference;
import social.tsu.cameracapturer.filter.Filter;
import social.tsu.cameracapturer.filter.FilterParser;
import social.tsu.cameracapturer.filter.Filters;
...
import social.tsu.cameracapturer.frame.Frame;
import social.tsu.cameracapturer.frame.FrameProcessor;
import social.tsu.cameracapturer.gesture.Gesture;
import social.tsu.cameracapturer.gesture.GestureAction;
import social.tsu.cameracapturer.gesture.GestureFinder;
import social.tsu.cameracapturer.gesture.GestureParser;
import social.tsu.cameracapturer.gesture.PinchGestureFinder;
import social.tsu.cameracapturer.gesture.ScrollGestureFinder;
import social.tsu.cameracapturer.gesture.TapGestureFinder;
import social.tsu.cameracapturer.internal.GridLinesLayout;
import social.tsu.cameracapturer.internal.utils.CropHelper;
import social.tsu.cameracapturer.internal.utils.OrientationHelper;
import social.tsu.cameracapturer.internal.utils.WorkerHandler;
import social.tsu.cameracapturer.markers.AutoFocusMarker;
import social.tsu.cameracapturer.markers.AutoFocusTrigger;
import social.tsu.cameracapturer.markers.MarkerLayout;
import social.tsu.cameracapturer.markers.MarkerParser;
import social.tsu.cameracapturer.overlay.OverlayLayout;
import social.tsu.cameracapturer.preview.CameraPreview;
import social.tsu.cameracapturer.preview.FilterCameraPreview;
import social.tsu.cameracapturer.preview.GlCameraPreview;
import social.tsu.cameracapturer.preview.SurfaceCameraPreview;
import social.tsu.cameracapturer.preview.TextureCameraPreview;
import social.tsu.cameracapturer.size.AspectRatio;
import social.tsu.cameracapturer.size.Size;
import social.tsu.cameracapturer.size.SizeSelector;
import social.tsu.cameracapturer.size.SizeSelectorParser;
import social.tsu.cameracapturer.size.SizeSelectors;
...
public class CameraView extends FrameLayout implements LifecycleObserver {
    ...
    public void setFilter(@NonNull Filter filter) {
        ...
        if (mCameraPreview == null) {
            ...
            FilterCameraPreview filterCameraPreview = ((FilterCameraPreview) mCameraPreview);
            filterCameraPreview.setFilter(filter);
        }
    }
