package social.tsu.cameracapturer.filter.image;
...
import social.tsu.cameracapturer.filter.image.util.OpenGlUtils;
import social.tsu.cameracapturer.filter.image.util.Rotation;
import social.tsu.cameracapturer.filter.image.util.TextureRotationUtil;
...
public class GPUImageRenderer implements GLSurfaceView.Renderer, GLTextureView.Renderer, PreviewCallback {
    ...
    public GPUImageRenderer(final Filter filter) {
        this.filter = filter;
    ...
    public void setFilter(final Filter filter) {
        runOnDraw(new Runnable() {
            ...
            @Override
            public void run() {
                final Filter oldFilter = GPUImageRenderer.this.filter;
