...
public class VideoPreviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.videoPreview).getLayoutParams().width = newCanvasWidth;
        findViewById(R.id.videoPreview).getLayoutParams().height = newCanvasHeight;


        ((TextureView) findViewById(R.id.videoPreview)).setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            @Override
