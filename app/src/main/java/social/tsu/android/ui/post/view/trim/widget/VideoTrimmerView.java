...
import social.tsu.android.ui.post.view.trim.features.trim.VideoTrimmerAdapter;
import social.tsu.android.ui.post.view.trim.features.trim.VideoTrimmerUtil;
import social.tsu.android.ui.post.view.trim.interfaces.IVideoTrimmerView;
import social.tsu.android.ui.post.view.trim.interfaces.VideoTrimListener;
import social.tsu.android.ui.post.view.trim.utils.StorageUtil;

import static social.tsu.android.ui.post.view.trim.features.trim.VideoTrimmerUtil.MAX_COUNT_RANGE;
import static social.tsu.android.ui.post.view.trim.features.trim.VideoTrimmerUtil.RECYCLER_VIEW_PADDING;
import static social.tsu.android.ui.post.view.trim.features.trim.VideoTrimmerUtil.THUMB_WIDTH;
import static social.tsu.android.ui.post.view.trim.features.trim.VideoTrimmerUtil.VIDEO_FRAMES_WIDTH;
...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
    ...
    private void initRangeSeekBarView() {
        ...
        mLeftProgressPos = 0;
        if (mDuration <= getMaxShootDuration()) {
        ...
        if (mThumbsTotalCount - MAX_COUNT_RANGE > 0) {
            mAverageMsPx = (mDuration - getMaxShootDuration()) / (float) (mThumbsTotalCount - MAX_COUNT_RANGE);
        } else {
            mAverageMsPx = 0f;
        }
