...
class MainFeedBoundaryCallback(
    ...
    override fun onZeroItemsLoaded() {
        execute {
            lastStartAtId = 0
            val startAtPost = postFeedDao.getOldestPost(FeedSource.Type.MAIN)
    ...
    private fun requestAndSaveData() {
        ...
        postFeedService.getPostFeed(startAt, PostFeedRepository.PAGE_SIZE, object :
            ...
            override fun onSuccess(result: PostFeedService.PostFeedResults) {
                ...
                execute {
                    postFeedDao.savePosts(result.posts, FeedSource.Type.MAIN)
                }
            }
